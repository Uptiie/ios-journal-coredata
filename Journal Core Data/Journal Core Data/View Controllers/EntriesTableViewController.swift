...
class EntriesTableViewController: UITableViewController {
    ...
    lazy var fetchResultsController: NSFetchedResultsController<Entry> = {
        ...
        let frc = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: CoreDataStack.shared.mainContext, sectionNameKeyPath: "Priority", cacheName: nil)
